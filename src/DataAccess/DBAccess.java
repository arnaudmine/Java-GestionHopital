...
public class DBAccess implements DataAccess {
    ...
    public ArrayList<String> getAllHeadsDepartmentName()throws Exception {
        ...
        try {
            ...
            String sqlInstruction = "SELECT hd.last_name, hd.first_name, s.type " +
            ...
            while(data.next()) {
                ...
                getAllHeadsDepartmentName.add(lastName + " " + firstName + " ("+type+")");
            }
        }
    ...
    public ArrayList<String> getAllConsultationType() throws Exception {
        ...
        try {
            Connection connection = SingletonConnexion.getInstance();
            String sqlInstruction = "SELECT type FROM consultation";
            PreparedStatement preparedStatement = connection.prepareStatement(sqlInstruction);
            ResultSet data = preparedStatement.executeQuery(sqlInstruction);
    ...
    public ArrayList<String> getAllNurses() throws Exception {
        ...
        try {
            Connection connection = SingletonConnexion.getInstance();
            String sqlInstruction = "SELECT last_name, first_name, service FROM nurse";
            PreparedStatement preparedStatement = connection.prepareStatement(sqlInstruction);
            ResultSet data = preparedStatement.executeQuery(sqlInstruction);
    ...
    public String getServiceByNurse(String nurseId) throws Exception {
        ...
        try {
            Connection connection = SingletonConnexion.getInstance();
            String sqlInstruction = "SELECT service " +
                    "FROM nurse " +
                    "WHERE id = '" + nurseId + "';";
